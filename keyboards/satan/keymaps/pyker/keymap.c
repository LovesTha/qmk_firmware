...
[_BL] = KEYMAP_ANSI(
  ...
  KC_LSPO,  KC_Z,    KC_X,    KC_C,         KC_V, KC_B, KC_N,          KC_M,     KC_COMM, KC_DOT, KC_SLSH,   KC_RSPC, \
      KC_LCTL,  KC_LGUI, 8,                    SPACEDUAL,            RALT_T(KC_PGUP), RGUI_T(KC_PGDN), TD(TD_UP_MENU), RCTL_T(KC_DOWN)),
...
[_SPC] = KEYMAP_ANSI(
  ...
  KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT,  KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS,          KC_TRNS, \
   ...
   */
[_TAB] = KEYMAP_ANSI(
  KC_TRNS, BL_1,    BL_3,    BL_5,    BL_7,    BL_9,    BL_0   , KC_KP_EQUAL, KC_KP_SLASH, KC_KP_ASTERISK, KC_KP_MINUS, KC_TRNS, KC_TRNS, RESET,   \
