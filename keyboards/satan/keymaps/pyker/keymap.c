...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_GV_ESC] = ACTION_TAP_DANCE_DOUBLE(KC_GRV, KC_ESC)
...
[_BL] = KEYMAP_ANSI(
  ...
  TABDUAL,  KC_Q,    KC_W,    TD(TD_E_END), KC_R, KC_T, KC_Y,          KC_U,     KC_I,    KC_O,   KC_P,    KC_LBRC, KC_RBRC, SLASHDUAL, \
  CAPSDUAL, KC_A,    KC_S,    KC_D,         KC_F, KC_G, TD(TD_H_HOME), KC_J,     KC_K,    KC_L,   KC_SCLN, KC_QUOT,          ENTERDUAL,  \
  KC_LSPO,  KC_Z,    KC_X,    KC_C,         KC_V, KC_B, KC_N,          KC_M,     KC_COMM, KC_DOT, KC_SLSH,   KC_RSPC, \
  KC_LCTL,  KC_LGUI, KC_LALT,                    SPACEDUAL,            RALT_T(KC_PGUP), RGUI_T(KC_PGDN), TD(TD_UP_MENU), RCTL_T(KC_DOWN)),
...
/* Keymap _SPC: Function Layer
   ...
   * |     |   |Up |   |   |   |   |   |Up |   |   |   |   |     |
   * |-----------------------------------------------------------|
   * |      |Left|Down|Rig|  |  |  |Left|Dow|Right|  |  | ToBase |
   * |-----------------------------------------------------------|
   * |        |Tk-|Puase|TK+|V+|V- |   |   |   |   |   |         |
   * |-----------------------------------------------------------|
   * |    |    |    |                        |    |    |    |    |
...
[_SPC] = KEYMAP_ANSI(
  ...
  KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS, TO(_BL), TO(_SPC),\
  KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT,  KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS,          TO(_BL), \
   ...
   */
[_TAB] = KEYMAP_ANSI(
  KC_TRNS, BL_1,    BL_3,    BL_5,    BL_7,    BL_9,    BL_0   , KC_KP_EQUAL, KC_KP_SLASH, KC_KP_ASTERISK, KC_KP_MINUS, KC_TRNS, KC_TRNS, KC_TRNS,   \
  KC_TRNS, KC_HOME, KC_UP,   KC_END,  KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_PLUS, KC_TRNS,  TO(_BL), TO(_TAB), \
  KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_ENTER, KC_TRNS,          TO(_BL), \
...
[_WORLD] = KEYMAP_ANSI(
  ...
  TO(_TAB),KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          TO(_BL), \
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS, \
  KC_TRNS, KC_TRNS, KC_TRNS,                            TO(_SPC),                           KC_M, KC_TRNS, KC_TRNS, KC_TRNS),
};
