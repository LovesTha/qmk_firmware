...
/* Macro layer */
[_MACRO] = KEYMAP( \
   _______, _______, EMAIL,   _______, _______, _______, _______, _______, _______, _______, _______, _______, \
   TICCTX , KC_1,    KC_2,    KC_3,    TREB00T, NEWTAB,  _______, _______, _______, _______, TRAINZ,  _______, \
   TICCISR, KC_4,    KC_5,    KC_6,    FINDALL, ASSRT,   TRICCM,  _______, K1441,   PLESS  , _______, _______, \

   _______, KC_7,    KC_8,    KC_9,    REMISR,  PROGRM,  TRICCS,  _______, _______, _______, _______, _______, \
   ADJUST , _______, KC_0,    _______, _______, _______, _______, _______, _______, _______, _______, _______  \
),
...
[_TARAK5] = KEYMAP( \
 KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_BSPC, \
 KC_TAB,  KC_Q,    KC_W,    KC_DOT,  KC_R,    KC_J,   KC_Y,   KC_F,   KC_G,    KC_SCLN, KC_P,    KC_BSPC, \
 KC_ESC,  KC_A,    KC_O,    KC_E,    KC_U,    KC_I,   KC_D,   KC_H,   KC_T,    KC_L,    KC_S,    KC_QUOT, \
 KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_K,    KC_B,   KC_N,   KC_M,   KC_COMM, KC_V,    KC_SLSH, KC_RSFT, \
 KC_LCTL, KC_LALT, KC_LGUI, MACRO,   NUMBER,  KC_ENT, KC_SPC, SYMBOL, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_ADJUST] =  KEYMAP( \
  ...
  _______, _______, _______, _______, _______, TARAK1 , TARAK2 , TARAK3 , TARAK4 , TARAK5 , _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
)
  ...
  switch (keycode) {
    ...
    case TARAK1:
      if (record->event.pressed) {
          ...
          PLAY_SONG(tone_dvorak);
        #endif
        persistent_default_layer_set(1UL<<_TARAK1);
      }
      return false;
      break;
    case TARAK2:
      if (record->event.pressed) {
          ...
          PLAY_SONG(tone_dvorak);
        #endif
        persistent_default_layer_set(1UL<<_TARAK2);
      }
      return false;
      break;
    case TARAK3:
      if (record->event.pressed) {
          ...
          PLAY_SONG(tone_dvorak);
        #endif
        persistent_default_layer_set(1UL<<_TARAK3);
      }
      return false;
      break;
    case TARAK4:
      if (record->event.pressed) {
          ...
          PLAY_SONG(tone_dvorak);
        #endif
        persistent_default_layer_set(1UL<<_TARAK4);
      }
      return false;
      break;
    case TARAK5:
      if (record->event.pressed) {
          ...
          PLAY_SONG(tone_dvorak);
        #endif
        persistent_default_layer_set(1UL<<_TARAK5);
      }
      return false;
      break;
    case NUMBER:
