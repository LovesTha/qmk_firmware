...
[_NUMBER] = LAYOUT( \
  ...
  RESET  , KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, KC_LCBR, KC_RCBR, KC_COLN, _______, \
...
[_MACRO] = LAYOUT( \
   ...
   _______, KC_4   , KC_5   , KC_6   , FINDALL, _______, RGB_VAI, _______, K1441  , PLESS  , _______, _______, \
   KC_CAPS, KC_1   , KC_2   , KC_3   , KC_BTN3, PROGRM , RGB_VAD, _______, KC_BTN1, KC_BTN2, KC_BTN3, KC_PIPE, \
