...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_BASE] = LAYOUT(
      MT(MOD_LALT, KC_TAB),  KC_Q, KC_W, KC_E,   KC_R,   KC_T,     KC_Y,   KC_U,    KC_I,    KC_O,    KC_P,    MT(MOD_RALT, KC_BSPC),
      MT(MOD_LSFT , KC_ESC),  KC_A, KC_S, KC_D,   KC_F,   KC_G,     KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, MT(MOD_RSFT, KC_QUOT),
      KC_LCTL,              KC_Z, KC_X, KC_C,   KC_V,   KC_B,     KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RCTL, KC_BSLASH),
      _______,          _______,_______, MO(_MACRO),  LCTL_T(KC_ENT), MO(_NUMBER), MO(_SYMBOL), RCTL_T(KC_SPC), MO(_MACRO), _______,_______,_______
    ),
    [_NUMBER] = LAYOUT( \
