 ...
 * `--------+------+------+------+------+-------                -------+------+------+------+------+--------'
 *                               | LGui | End  | LAlt |  |  Le  |  Do  |  Ri  |
 *                               `--------------------'  `--------------------'
 */
[BASE] = LAYOUT_ltstagger(
    LT(NUMB, KC_ESC),       KC_Q,  KC_W,   KC_E,   KC_R, KC_T,                                        KC_Y,    KC_U, KC_I, KC_O,   KC_P,    KC_PIPE,
    MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_S,   KC_D,   KC_F, KC_G,                                        KC_H,    KC_J, KC_K, KC_L,   KC_SCLN, KC_QUOT,
    KC_RSFT,                KC_Z,  KC_X,   KC_C,   KC_V, KC_B,                                        KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
                   MT(MOD_LGUI, KC_DEL), MT(MOD_LALT, KC_ENT), LT(SYMB, KC_SPC),    LT(SYMB, KC_ENT), LT(NUMB, KC_SPC), KC_TAB
    ),
...
[SYMB] = LAYOUT_ltstagger(
    ...
    KC_TRNS, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD,          KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,
                               KC_TRNS, KC_TRNS, KC_SCLN,          KC_EQL,  KC_SCLN, KC_PGUP
    ),
 ...
 *                                 `--------------'                     `--------------'
 */
[NUMB] = LAYOUT_ltstagger(
    KC_TRNS, KC_1, 	  KC_2,    KC_3,    KC_4,    KC_5,                                             KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_TRNS,
    KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_VOLD, KC_VOLU,
    KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,         KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_MPLY, KC_MNXT,
